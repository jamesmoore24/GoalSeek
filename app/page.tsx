  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Personal AI Assistant</h1>
          <p className="text-gray-600">Your intelligent companion for goal achievement and daily optimization</p>
        </div>
            ...
            {activeTab === "calendar" && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Google Calendar sync coming soon</CardDescription>
                </CardHeader>
              </Card>
            )}
          </div>
